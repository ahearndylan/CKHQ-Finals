...
def get_game_ids_and_number(date_str, max_retries=3):
...
💪 REB: {rebounds['player']} ({rebounds['team']}) – {rebounds['value']}
...
def run_bot():
    ...
    try:
        game_ids, game_number = get_game_ids_and_number(date_str)
        ...
        tweet = compose_finals_tweet(date_str, game_number, points, assists, rebounds, threes)
